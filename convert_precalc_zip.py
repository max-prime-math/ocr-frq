...
matching the format of output_latex/output_frq.tex.

Usage:
    python convert_precalc_zip.py <zip_file> [output_tex]

Example:
    python convert_precalc_zip.py mathpix/pre-calc-40s_jan_13_mg-only_cleaned_aggressive.zip
"""
