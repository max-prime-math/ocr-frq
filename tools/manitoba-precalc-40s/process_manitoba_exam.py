...
Usage: python tools/manitoba-precalc-40s/process_manitoba_exam.py <zip_file>
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python tools/manitoba-precalc-40s/process_manitoba_exam.py <zip_file>")
        print("\nExample:")
        print("  python tools/manitoba-precalc-40s/process_manitoba_exam.py data/legacy/manitoba-prototype-mathpix/raw-mathpix/pre-calc-40s_jan_13_mg-only_cleaned_aggressive.zip")
        sys.exit(1)
